...
func printRecursiveStory(_ n: Int, _ current: Int) {
    let indentation = String(repeating: "____", count: current)
    ...
    printRecursiveStory(n, current + 1)
